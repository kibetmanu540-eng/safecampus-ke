    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Browse and filter all submitted reports</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                className="border rounded px-2 py-1 text-xs text-gray-700 bg-white"
                value={reportFilters.university}
                onChange={(e) => setReportFilters((prev) => ({ ...prev, university: e.target.value }))}
              >
                <option value="all">All</option>
            ...
            <Button size="sm" variant="outline" onClick={fetchAllReports} disabled={allReportsLoading}>
              {allReportsLoading ? 'Refreshing...' : 'Refresh'}
            </Button>
          </div>
            ...
            <table className="min-w-full text-xs text-left text-gray-700">
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="px-2 py-2">Suspect</th>
                  <th className="px-2 py-2">Survivor Contact</th>
                  ...
                  filteredReports.map((report) => {
                    ...
                    return (
                      <tr key={report.id} className="border-b last:border-0">
                        ...
                        <td className="px-2 py-1 align-top">
                          {report.type?.replace('-', ' ') || 'Unknown'}
                        </td>
                        <td className="px-2 py-1 align-top">
                          {report.university ? report.university.toUpperCase() : 'Not specified'}
                        </td>
                        <td className="px-2 py-1 align-top">
                          {report.status || 'new'}
                        </td>
